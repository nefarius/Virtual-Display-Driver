#define MyAppName "Universal Virtual Display Driver"
...
[Files]
Source: "..\mttvdd.cat"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\MttVDD.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Virtual_Display_Driver.cer"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\MttVDD.inf"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Setup.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\vdd_settings.xml"; DestDir: "{app}"; Flags: ignoreversion
